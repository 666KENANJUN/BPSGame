...
namespace BPSGame.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/BPSGame/DataTables";
        private const string CSharpCodePath = "Assets/BPSGame/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/BPSGame/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "BPSGame");
